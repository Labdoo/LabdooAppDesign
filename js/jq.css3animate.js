        ...
        css3Animate.prototype = {
            animate:function(options){
                ...
                if(classMode){
                    ...
                    var timeDelay = numOnly(options["delay"]);

                    if(timeNum==0) options["time"]=0;
                    if(timeDelay==0) options["delay"]=0;
                    ...
                    if((""+options["delay"]).indexOf("s")===-1) {
                        var scale = 'ms';
                        var delay = options["delay"]+scale;
                    } else if(options["delay"].indexOf("ms")!==-1){
                        var scale = 'ms';
                    ...
                    this.el.style[$.feat.cssPrefix+"TransitionDelay"] = delay;
